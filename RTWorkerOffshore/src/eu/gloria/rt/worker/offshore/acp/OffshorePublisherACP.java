...
public class OffshorePublisherACP extends OffshorePluginPublisher implements OffshorePublisher{
	...
	public void publish(String idOp) throws RTSchException {
		...
		String acp_http_port = getPropertyValueString("acp_http_port");
			...
			if (dbOp != null){
				...
				try{
					...
					if (rtml.exists()){
						...
						uploader.upload(acp_http_auth_user, acp_http_auth_pw, acp_http_ip, acp_http_port, acp_http_rtml_upload_url, rtmlFile);
